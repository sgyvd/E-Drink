...
public class RegexUtils {
    ...
    /**
     * 匹配手机号码的正则表达式
     * <br>支持130——139、150——153、155——159、170-179、180、183、185、186、188、189号段
     */
    public static final String PHONE_NUMBER_REGEX = "^1{1}(3{1}\\d{1}|5{1}[012356789]{1}|7{1}\\d{1}|8{1}[035689]{1})\\d{8}$";
    ...
    /**
     * 匹配给定的字符串是否是一个手机号码，支持130——139、150——153、155——159、170-179、180、183、185、186、188、189号段
     *
     * @param string 给定的字符串
     * @return true：是
     */
